...
``func`` is the event handler of the window, see below.
...
that is why we give the function ``func`` as a fourth parameter of
:func:`ez_window_create`.

.. index:: Callback; Example

The event handler ``func`` (also named *callback*), is a function of
